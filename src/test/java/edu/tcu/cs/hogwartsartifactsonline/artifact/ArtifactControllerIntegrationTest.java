...
class ArtifactControllerIntegrationTest {
    ...
    void testAddArtifactSuccess() throws Exception {
        ...
        Map<String, String> artifactJson = new HashMap<>();
        artifactJson.put("name", "Remembrall");
        artifactJson.put("description", "A Remembrall was a magical large marble-sized glass ball that contained smoke which turned red when its owner or user had forgotten something. It turned clear once whatever was forgotten was remembered.");
        artifactJson.put("imageUrl", "ImageUrl");
        String json = objectMapper.writeValueAsString(artifactJson);
